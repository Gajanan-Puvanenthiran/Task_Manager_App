package com.gajanan.Task.Manager.App.config.aspect;
...
public class LoggingAspect {
    ...
    @Pointcut(value = "within(com.gajanan.Task.Manager.App.controller..*) || within(com.gajanan.Task.Manager.App.service.impl..*)")
